...
class Config:
    ...
    # 파일 경로 설정
    data_x_product_path: str = "./DLResource/PreprocessData/data_X_product_5.csv"  # 입력 제품 시퀀스
    data_y_path: str = "./DLResource/PreprocessData/data_Y_5.csv"                  # 타겟 제품 정보
    embeddings_path: str = "./DLResource/ev_final64.npy"                           # 제품 임베딩 벡터
    products_path: str = "./DLResource/RawData/products.csv"                       # 제품 메타 정보
    ...
    # CNN 모델 구조 설정
    cnn_out_channels: int = 256             # CNN 출력 채널 수
